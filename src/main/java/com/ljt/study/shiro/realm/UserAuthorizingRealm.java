 ...
 */
@Slf4j
class UserAuthorizingRealm extends AuthorizingRealm {

    /**
     * 模拟调试用
     */
    static final String AUTH_PWD = "user";

    @Override
    public boolean supports(AuthenticationToken token) {
        return token instanceof CustomAuthToken && USER == ((CustomAuthToken) token).getLoginTypeEnum();
    }
